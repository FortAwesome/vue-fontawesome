...
typeof exports === 'object' && typeof module !== 'undefined'
    ? factory(exports, require('@fortawesome/fontawesome-svg-core'))
    : typeof define === 'function' && define.amd
          ? define([ 'exports', '@fortawesome/fontawesome-svg-core' ], factory)
  ...
  (function(global) {
    var _processKeys = function(convert, obj, options) {
      if (!_isObject(obj) || _isDate(obj) || _isRegExp(obj) ||
          _isBoolean(obj) || _isFunction(obj)) {
        return obj;
      }
      ...
      if (_isArray(obj)) {
        ...
        for (var key in obj) {
          if (Object.prototype.hasOwnProperty.call(obj, key)) {
            output[convert(key, options)] =
                _processKeys(convert, obj[key], options);
          }
        }
      }
      return output;
    ...
    var decamelize = function(
        string,
        options) { return separateWords(string, options).toLowerCase(); };
    ...
    var _isObject = function(obj) { return obj === Object(obj); };
    var _isArray = function(
        obj) { return toString.call(obj) == '[object Array]'; };
    var _isDate = function(
        obj) { return toString.call(obj) == '[object Date]'; };
    var _isRegExp = function(
        obj) { return toString.call(obj) == '[object RegExp]'; };
    var _isBoolean = function(
        obj) { return toString.call(obj) == '[object Boolean]'; };
    ...
    var _processor = function(convert, options) {
      ...
      return function(string,
                      options) { return callback(string, convert, options); }
    };
    ...
    var humps = {
      ...
      depascalizeKeys :
          function() { return this.decamelizeKeys.apply(this, arguments); }
    };
...
function combineClassObjects() {
  for (var _len = arguments.length, objs = Array(_len), _key = 0; _key < _len;
       _key++) {
...
function convert(h, element) {
  ...
  var _data$class = data.class,
      ...
      remainingData =
          objectWithoutProperties(data, [ 'class', 'style', 'attrs' ]);
...
function classList(props) {
  ...
  var classes =
      (_classes = {
       ...
       defineProperty(_classes, 'fa-rotate-' + props.rotation,
                      props.rotation !== null),
...
function normalizeIconArgs(icon) {
  ...
  if ((typeof icon === 'undefined' ? 'undefined' : _typeof(icon)) ===
          'object' &&
...
var FontAwesomeIcon = {
  ...
  props : {
    ...
    size : {
      ...
      validator : function validator(value) {
        return [
          'lg', 'xs', 'sm', '1x', '2x', '3x', '4x', '5x', '6x', '7x', '8x',
          '9x', '10x'
        ].indexOf(value) > -1;
      }
    },
...
var FontAwesomeLayers = {
  ...
  render : function render(createElement, context) {
    ...
    var classes = [ familyPrefix + '-layers' ].concat(toConsumableArray(
...
var FontAwesomeLayersText = {
  ...
  render : function render(createElement, context) {
    ...
    var renderedText = fontawesomeSvgCore.text(
        props.value.toString(), _extends({}, transform, classes));

    var abstract = renderedText.abstract;

    if (props.counter) {
      abstract[0].attributes.class =
          abstract[0].attributes.class.replace('fa-layers-text', '');
    }
